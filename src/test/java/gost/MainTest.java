...
public class MainTest {
    ...
    public void success256() throws Exception {
        Main.main(new String[]{"-p", "Parameters/Signature256.json", "-m", "TestDirectory/message.txt", "-s", "Keys/private256.key"});
        Main.main(new String[]{"-p", "Parameters/Signature256.json", "-q", "Keys/private256.key", "-o", "TestDirectory/publicQ256.kq"});
        outputStreamCaptor.reset();
        Main.main(new String[]{"-p", "Parameters/Signature256.json", "-m", "TestDirectory/message.txt", "-v", "TestDirectory/publicQ256.kq", "-sig", "TestDirectory/message.txt.sig"});
    ...
    public void success512() throws Exception {
        Main.main(new String[]{"-p", "Parameters/Signature512.json", "-m", "TestDirectory/message.txt", "-s", "Keys/private512.key"});
        Main.main(new String[]{"-p", "Parameters/Signature512.json", "-q", "Keys/private512.key", "-o", "TestDirectory/publicQ512.kq"});
        outputStreamCaptor.reset();
        Main.main(new String[]{"-p", "Parameters/Signature512.json", "-m", "TestDirectory/message.txt", "-v", "TestDirectory/publicQ512.kq", "-sig", "TestDirectory/message.txt.sig"});
        final var expected = "Подпись успешно прошла проверку";
        assertEquals(expected, outputStreamCaptor.toString().trim());
    }
    ...
    public void unsuccess256() throws Exception {
        Main.main(new String[]{"-p", "Parameters/Signature256.json", "-m", "TestDirectory/message.txt", "-s", "Keys/private256.key"});
        Main.main(new String[]{"-p", "Parameters/Signature512.json", "-q", "Keys/private256.key", "-o", "TestDirectory/publicQ256.kq"});
        outputStreamCaptor.reset();
        Main.main(new String[]{"-p", "Parameters/Signature256.json", "-m", "TestDirectory/message.txt", "-v", "TestDirectory/publicQ256.kq", "-sig", "TestDirectory/message.txt.sig"});
    ...
    public void incorrectFlag() {
        assertThrows(Exception.class, () -> Main.main(new String[]{"-t", "Parameters/Signature256.json", "-m", "TestDirectory/message.txt", "-s", "Keys/private256.key"}));
    ...
    public void incorrectQcreate() {
        assertThrows(Exception.class, () -> Main.main(new String[]{"-p", "Parameters/Signature512.json", "-q", "Keys/private512.key"}));
    }
    ...
    public void incorrectVerificationKey() {
        assertThrows(Exception.class, () -> Main.main(new String[]{"-p", "Parameters/Signature256.json", "-m", "TestDirectory/message.txt", "-v", "TestDirectory/publicQ256.kq", "-sig", "TestDirectory/message.txt.sig"}));
    }
    ...
    public void incorrectSaving() {
        assertThrows(Exception.class, () -> Main.main(new String[]{"-p", "Parameters/Signature256.json", "-m", "TestDirectory/message.txt", "-s", "Keys/private256.key", "-o", "/root/message.sig"}));
        assertThrows(Exception.class, () -> Main.main(new String[]{"-p", "Parameters/Signature256.json", "-q", "Keys/private256.key", "-o", "/root/publicQ256.kq"}));
    }
    ...
    public void parametersView() throws Exception {
        Main.main(new String[]{"-p", "Parameters/Signature512.json"});
        var parameters = """
